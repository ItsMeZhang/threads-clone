        ...
        <div class=" py-2 w-full">
            <div class="flex items-center justify-between">
                <div  class="flex items-center text-white">
                    <!-- Bagian Nama dan Foto Profil Pengguna -->
                    <img class="rounded-full h-[35px]" :src="post.image">
                    <div class="ml-2 font-semibold text-[18px]">{{ post.name }}</div>
                </div>
                <!-- Check Jika Postingan merupakan milik user dengan membandingkan user_id dari table users dengan posts, maka user dapat menghapus postingannya -->
                <div 
...
console.log("supabase useer", user)
